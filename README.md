...
<table>
  ...
  - "path2"</code></pre></td>
        ...
        <tr>
            <td valign="top"><code style="white-space: nowrap;">--configpaths</code><br>
            <code>--cps</code></td>
  ...
  combinedplot:
    ...
    - "path2"</code></pre></td>
        ...
        <tr valign="top">
            <td valign="top"><code style="white-space: nowrap;">--save-config</code><br>
            <code>--sc</code></td>
